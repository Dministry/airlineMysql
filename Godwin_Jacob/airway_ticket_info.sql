...
CREATE TABLE `ticket_info` (
  ...
  `flight_department_date` timestamp NULL DEFAULT NULL,
  KEY `ticket_info_idx` (`profile_id`),
  KEY `ticket_info3_idx` (`flight_department_date`),
  KEY `ticket_info2_idx` (`flight_id`)
...
-- Dump completed on 2020-02-17 16:00:46
