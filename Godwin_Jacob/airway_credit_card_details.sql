...
CREATE TABLE `credit_card_details` (
  ...
  `expiration_month` datetime DEFAULT NULL,
  `expiration_year` year DEFAULT NULL,
  KEY `profileId_idx` (`profile_id`),
  CONSTRAINT `profileId` FOREIGN KEY (`profile_id`) REFERENCES `passenger_info` (`profile_id`)
...
INSERT INTO `credit_card_details` VALUES (1,436486906,'Master_Card','2020-02-25 11:58:26',2023);
...
-- Dump completed on 2020-02-17 16:00:44
